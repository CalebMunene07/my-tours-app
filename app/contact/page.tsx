...
export default function ContactPage() {
  // Since this is a general contact page, we'll provide generic props to the form
  const genericPricing = ["Luxury", "Mid-Range", "Budget"];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            ...
            Fill out the form below or reach out to our Nairobi office directly.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="bg-green-100 p-3 rounded-full text-[#4B5320]">
                    <Phone size={24} />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@wikimasafari.com</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-8">
            <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-gray-100">
              ...
              {/* Reusing your BookingForm component */}
              <BookingForm 
                tourTitle="Custom Trip Inquiry" 
                pricingTiers={genericPricing} 
              />
            </div>
          </div>
